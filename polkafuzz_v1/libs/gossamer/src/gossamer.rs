...
extern "C" {
    pub fn gfuzz_genesis_json_from_bytes(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_new_multiaddr_bytes(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_new_multiaddr(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_decode_babepredigest(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_publickey_from_proto(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_peerid_from_bytes(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_multihash_from_bytes(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_decode_babenextepoch(data_ptr: *mut u8, data_size: usize) -> bool;

    pub fn gfuzz_decode_header(data_ptr: *mut u8, data_size: usize) -> bool;
}
...
pub fn gossamer_decode_header(data: &[u8]) -> bool {
    ...
    let data_ptr: *mut u8 = dt.as_mut_ptr();
    let data_size: usize = data.len() as usize;
    unsafe { gfuzz_decode_header(data_ptr, data_size) }
}
